# 1) Crear una lista con los números del 1 al 100 que sean múltiplos de 4. Utilizar la funciónrange.
...
lista_5_elementos = [1, 2, "hola", "mundo", False]
...
print(numeros)
#Este programa se encarga de aplicar el .remove y solicita que el numero a quitar de la lista sea el mas alto con max(numeros) en este caso el 22
